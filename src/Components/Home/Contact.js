...
import company1 from '../../images/d1f037cce542c04dbc9a078a7e8c3d31_600x147_0x32_600x232.png'
import company2 from '../../images/b6ea7dd686fa817743d40b1b36475f5f_600x188.png'
const Contact = () => {
    return (
...
<p>41a rue des Romains, 8041 Luxembourg</p>
            ...
            <section className='footer d-flex justify-content-center '>
                <img width={'150px'} src={company2} alt="" />
                <img width={'150px'} src={company1} alt="" />
            </section>
            </div>
